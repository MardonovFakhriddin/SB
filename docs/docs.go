        ...
        "/accounts": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid input, user not found, account already exists, or invalid currency",
                        "schema": {
                            "type": "object",
        ...
        "/transfers": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid input, invalid user ID, mismatched currencies, or insufficient balance",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
